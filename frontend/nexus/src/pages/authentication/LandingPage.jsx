          ...
          <div className="landing-layout">
              ...
              <div className="landing-copy">
                ...
                <div className="landing-highlights" aria-label="Nexus capabilities">
                  <div className="landing-highlight">
                    <span className="landing-highlight-icon" aria-hidden="true">01</span>
                    <span>Organize requests</span>
                  </div>
                  <div className="landing-highlight">
                    <span className="landing-highlight-icon" aria-hidden="true">02</span>
                    <span>Collaborate clearly</span>
                  </div>
                  <div className="landing-highlight">
                    <span className="landing-highlight-icon" aria-hidden="true">03</span>
            ...
            <aside className="landing-visual" aria-label="Nexus workspace overview">
              <img
                ...
                alt="Nexus workspace connecting tickets, conversations, and teams"
              />
