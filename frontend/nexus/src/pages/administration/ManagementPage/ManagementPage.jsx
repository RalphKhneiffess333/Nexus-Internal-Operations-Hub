...
import { ManagementTabs } from '../../../components/administration/ManagementTabs/ManagementTabs'
import { DepartmentsSection } from '../../../components/administration/DepartmentsSection/DepartmentsSection'
import { PrioritiesSection } from '../../../components/administration/PrioritiesSection/PrioritiesSection'
import { UsersSection } from '../../../components/administration/UsersSection/UsersSection'
...
export function ManagementPage() {
  ...
  return (
    <section className={`page administration-page ${administrationStyles.moduleAnchor}`}>
